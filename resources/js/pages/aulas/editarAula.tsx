...
export default function EditarAula() {
    // ts-ignore
    const { aula, modulo, curso }: { aula: Aula; modulo: Modulo; curso: Curso } = usePage().props;
    ...
    const submit = (e: React.FormEvent) => {
        ...
        put(route('aulaUpdate', { aula: aula.id }), {
            preserveScroll: true,
            ...
            <DefaultLayout>
                ...
                <div className="mx-auto w-full max-w-3xl space-y-6 px-3 pb-10">
                    <div className="flex items-start justify-between gap-3">
                        <div>
                            <h2 className="text-primary text-xl font-bold dark:text-white">Editar Aula</h2>
